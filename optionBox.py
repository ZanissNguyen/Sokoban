...
class OptionBox():
    ...
    def draw(self, surf):
        pygame.draw.rect(surf, self.highlight_color if self.menu_active else self.color, self.rect, 2, border_radius=10)
        ...
        if self.draw_menu:
            ...
            pygame.draw.rect(surf, (0, 0, 0), outer_rect, 2, border_radius=10)
